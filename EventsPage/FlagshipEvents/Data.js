export const FE_previewItems = [
    ...
    {
      id: 3,
      ImageURL: 'https://picsum.photos/400', // move to main events
      PreviewDescription:
    ...
    {
      id: 4,
      ImageURL: 'https://picsum.photos/600', // GTA (to be updated)
      PreviewDescription:
    ...
    {
      id: 5,
      ImageURL: 'https://picsum.photos/500', // Genesys (to be updated)
      PreviewDescription:
    ...
    {
      id: 6,
      ImageURL: 'https://picsum.photos/600', // Axiom (to be updated)
      PreviewDescription:
    ...
    {
      id: 7,
      ImageURL: 'https://picsum.photos/400', // APS (to be updated)
      PreviewDescription:
  ...
  export const FE_descriptionItems = [
    ...
    {
      id: 3,
      Heading: 'HUSTLEMANIA 3.O', // move to main events
      Description:
    ...
    {
      id: 4,
      Heading: 'Campus Survival: The VR Expedition', // GTA (to be updated)
      Description:
    ...
    {
      id: 5,
      Heading: 'MAZEHUNT', // Genesys (to be updated)
      Description:
    ...
    {
      id: 6,
      Heading: 'OMEGA', // Axiom (to be updated)
      Description:
        'Get ready for Death Race, a two-day robotics competition where participants drive their robots through a track filled with obstacles and challenges. The fastest robot to navigate the course and score the most points wins. Brace yourself for an intense and thrilling showdown!',
    ...
    {
      id: 7,
      Heading: 'METEOR MADNESS', // APS (to be updated)
      Description:
